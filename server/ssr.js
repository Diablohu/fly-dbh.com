...
/***/ "./src/assets/banner/30fps/low.mp4":
/*!*****************************************!*\
  !*** ./src/assets/banner/30fps/low.mp4 ***!
  \*****************************************/
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "includes/asset.3351ea8124a215427fef99a3ab805e36.mp4");

/***/ }),

/***/ "./src/assets/banner/30fps/medium.webm":
/*!*********************************************!*\
  !*** ./src/assets/banner/30fps/medium.webm ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "includes/asset.266a6a660ebf0880f0c2b418204caa37.webm");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const wrapper = 'e98e48';const css = '.e98e48{border-left:40px solid transparent;border-right:40px solid transparent;margin-left:auto;margin-right:auto;max-width:1280px;position:relative;width:100%}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const wrapper = 'b7b8e4';const css = '.b7b8e4{stroke-width:0;stroke:currentColor;fill:currentColor;display:inline-block;height:16px;vertical-align:text-top;width:16px}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const wrapper = 'cc8d58';const css = '.cc8d58{border:1px solid rgba(0,0,0,.35);border-radius:1em;color:#000;cursor:default;display:inline-block;font-size:14px;line-height:1.1em;padding:4px 8px;position:relative}.cc8d58.is-on{background:rgba(0,0,0,.35);color:#fff}.cc8d58[data-tag=clip]{background:hsla(0,0%,82%,.35);border-color:rgba(130,145,160,.35)}.cc8d58[data-tag=clip].is-on{background-color:rgba(130,145,160,.8);border-color:rgba(130,145,160,.8)}.cc8d58[data-tag=training]{background:hsla(3,79%,72%,.35);border-color:rgba(240,13,1,.35)}.cc8d58[data-tag=training].is-on{background-color:rgba(240,13,1,.8);border-color:rgba(240,13,1,.8)}.cc8d58[data-tag=landing]{background:rgba(17,213,184,.35);border-color:rgba(0,103,87,.35)}.cc8d58[data-tag=landing].is-on{background-color:rgba(0,103,87,.8);border-color:rgba(0,103,87,.8)}.cc8d58[data-tag=airport]{background:rgba(206,130,215,.35);border-color:rgba(170,31,186,.35)}.cc8d58[data-tag=airport].is-on{background-color:rgba(170,31,186,.8);border-color:rgba(170,31,186,.8)}.cc8d58[data-tag=device]{background:rgba(197,189,250,.35);border-color:rgba(82,57,255,.35)}.cc8d58[data-tag=device].is-on{background-color:rgba(82,57,255,.8);border-color:rgba(82,57,255,.8)}.cc8d58[data-tag=mod]{background:hsla(60,56%,65%,.35);border-color:rgba(179,179,24,.35)}.cc8d58[data-tag=mod].is-on{background-color:rgba(179,179,24,.8);border-color:rgba(179,179,24,.8)}.cc8d58[data-tag=tour]{background:rgba(68,168,240,.35);border-color:rgba(0,105,180,.35)}.cc8d58[data-tag=tour].is-on{background-color:rgba(0,105,180,.8);border-color:rgba(0,105,180,.8)}.cc8d58[data-tag=route]{background:hsla(28,57%,81%,.35);border-color:rgba(228,139,57,.35)}.cc8d58[data-tag=route].is-on{background-color:rgba(228,139,57,.8);border-color:rgba(228,139,57,.8)}.cc8d58[data-tag=news]{background:rgba(118,110,33,.35);border-color:rgba(21,19,3,.35)}.cc8d58[data-tag=news].is-on{background-color:rgba(21,19,3,.8);border-color:rgba(21,19,3,.8)}.cc8d58[data-tag=flight]{background:rgba(72,97,8,.35);border-color:rgba(0,0,0,.35)}.cc8d58[data-tag=flight].is-on{background-color:rgba(0,0,0,.8);border-color:rgba(0,0,0,.8)}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const wrapper = 'cc4747';const css = '.cc4747{grid-gap:40px;display:grid;grid-template-columns:repeat(auto-fill,minmax(240px,1fr));margin:0 auto;position:relative}.cc4747-item{cursor:default;position:relative;transition:none .15s ease-out;z-index:10}.cc4747-item:after{background:#fff;border:1px solid #26a69a;border-radius:7px;bottom:-15px;box-shadow:0 25px 20px -20px rgba(0,0,0,.25);content:"";left:-10px;opacity:0;position:absolute;right:-10px;top:-10px;transition:inherit;transition-property:opacity;z-index:-1}.cc4747-item>.thumbnail{background:no-repeat 50% 50%;background-size:cover;background:#26a69a;border:solid #26a69a;border-radius:5px 5px 0 0;border-width:1px 1px 0;display:block;height:0;overflow:hidden;padding-bottom:56.25%;position:relative;transition:inherit;transition-property:-webkit-filter;transition-property:filter;transition-property:filter,-webkit-filter;width:100%}.cc4747-item>.thumbnail>img{display:block;height:100%;left:0;object-fit:cover;position:absolute;top:0;width:100%}.cc4747-item>.links{background:#26a69a;border:1px solid #26a69a;border-radius:0 0 5px 5px;border-top:0;display:block;margin-top:0;text-align:left}.cc4747-item>.links,.cc4747-item>.links>a{height:50px;overflow:hidden;transition:inherit}.cc4747-item>.links>a{color:transparent !important;display:inline-block;position:relative;transition-property:background-color;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;vertical-align:top;width:50%}.cc4747-item>.links>a:after{bottom:0;box-shadow:inset 0 5px 10px rgba(0,0,0,.25);content:"";left:0;position:absolute;right:0;top:0}.cc4747-item>.links>a svg{fill:#26a69a;fill:#fff;display:block;height:30px;left:50%;margin-left:-15px;margin-top:-15px;position:absolute;top:50%;transition:inherit;transition-property:-webkit-transform;transition-property:transform;transition-property:transform,-webkit-transform;width:30px}.cc4747-item>.links>a.bilibili{background:#67acc3}.cc4747-item>.links>a.youtube{background:#d27979}html.is-hover .cc4747-item>.links>a:hover svg{-webkit-transform:scale(1.2);transform:scale(1.2)}html.is-hover .cc4747-item>.links>a:focus{outline:0}html.is-hover .cc4747-item>.links>a:focus:not(:active) svg{-webkit-transform:scale(1.2);transform:scale(1.2)}.cc4747-item>.infos{display:-webkit-flex;display:flex;-webkit-flex-flow:row wrap;flex-flow:row wrap;margin-top:12px;padding:0 8px 0 4px;width:100%}.cc4747-item>.infos>.date,.cc4747-item>.infos>.name,.cc4747-item>.infos>.tags{display:block}.cc4747-item>.infos>.tags{-webkit-flex:1;flex:1;margin-bottom:.5em}.cc4747-item>.infos>.tags .tag{margin-right:.5em}.cc4747-item>.infos>.name{color:#26a69a;-webkit-flex:1 0 100%;flex:1 0 100%;font-size:20px;line-height:1.2}.cc4747-item>.infos>.date{-webkit-flex:0;flex:0;font-size:14px;font-style:italic;line-height:1.2;margin-left:1em;margin-top:4px;white-space:nowrap}html.is-hover .cc4747-item:hover>.thumbnail{-webkit-filter:none;filter:none}html.is-hover .cc4747-item:hover>.links>a.bilibili{background:#07a3d7}html.is-hover .cc4747-item:hover>.links>a.youtube{background:red}html.is-hover .cc4747-item:hover:after{opacity:1}html.is-hover .cc4747-item:focus{outline:0}html.is-hover .cc4747-item:focus:not(:active)>.thumbnail{-webkit-filter:none;filter:none}html.is-hover .cc4747-item:focus:not(:active)>.links>a.bilibili{background:#07a3d7}html.is-hover .cc4747-item:focus:not(:active)>.links>a.youtube{background:red}html.is-hover .cc4747-item:focus:not(:active):after{opacity:1}.cc4747-item.mod-has-source{cursor:pointer;text-decoration:none;transition-property:-webkit-transform;transition-property:transform;transition-property:transform,-webkit-transform}.cc4747-item.mod-has-source:active,html.is-hover .cc4747-item.mod-has-source:hover:active{-webkit-transform:scale(.95);transform:scale(.95)}.cc4747-item.mod-has-source>.thumbnail{border-bottom-width:1px;border-radius:5px}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _assets_banner_cover_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @assets/banner/cover.jpg */ "./src/assets/banner/cover.jpg");
/* harmony import */ var _assets_sim_pilot_plate_svg__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @assets/sim-pilot-plate.svg */ "./src/assets/sim-pilot-plate.svg");
const wrapper = 'b8622b';const css = '.b8622b,.b8622b-banner{position:relative}.b8622b-banner{background:no-repeat 50% 50%;background-image:url("' + _assets_banner_cover_jpg__WEBPACK_IMPORTED_MODULE_0__.default + '");background-size:cover;height:75vh;max-height:800px;min-height:340px;overflow:hidden;width:100%}.b8622b-banner:after,.b8622b-banner:before,.b8622b-banner>.video,.b8622b-banner>.wrapper{bottom:0;content:"";-webkit-flex:none;flex:none;left:0;position:absolute;right:0;top:0}.b8622b-banner:after{background:rgba(0,0,0,.15);z-index:10}.b8622b-banner:before{background-image:radial-gradient(rgba(0,0,0,.1) 66.6667%,transparent 0);background-size:4px 4px;z-index:100}.b8622b-banner>.wrapper{--scale:1;-webkit-align-items:center;align-items:center;display:-webkit-flex;display:flex;-webkit-flex-flow:column nowrap;flex-flow:column nowrap;-webkit-justify-content:space-around;justify-content:space-around;opacity:var(--scale);padding:0 30px;-webkit-transform:scale(var(--scale));transform:scale(var(--scale));-webkit-transform-origin:50% 100%;transform-origin:50% 100%;z-index:200}.b8622b-banner>.wrapper:after,.b8622b-banner>.wrapper:before{content:"";-webkit-flex:1;flex:1}.b8622b-banner>.video{--offsetY:0;background:no-repeat 50% 50%;background-image:url("' + _assets_banner_cover_jpg__WEBPACK_IMPORTED_MODULE_0__.default + '");background-size:cover;height:100%;object-fit:cover;-webkit-transform:translateY(calc(var(--offsetY)*1px));transform:translateY(calc(var(--offsetY)*1px));width:100%;z-index:1}.b8622b-banner .logo{background:url("' + _assets_sim_pilot_plate_svg__WEBPACK_IMPORTED_MODULE_1__.default + '") no-repeat 50% 50%;background-size:contain;color:transparent;-webkit-flex:1;flex:1;margin:0;min-height:200px;padding:0;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.b8622b-banner .subscribe{-webkit-flex:none;flex:none;padding-top:5vh}.b8622b-banner .subscribe>a{border-radius:10px;color:#fff;display:inline-block;line-height:40px;margin:0 10px;padding-left:60px;padding-right:20px;position:relative;text-decoration:none;transition:-webkit-transform .2s ease-out;transition:transform .2s ease-out;transition:transform .2s ease-out,-webkit-transform .2s ease-out}.b8622b-banner .subscribe>a>.icon{fill:#fff;background:no-repeat 50% 50%;background-size:contain;bottom:7px;content:"";display:block;height:26px;left:10px;position:absolute;top:7px;width:40px}.b8622b-banner .subscribe>a.youtube{background:red}.b8622b-banner .subscribe>a.bilibili{background:#07a3d7}html.is-hover .b8622b-banner .subscribe>a:hover{color:#fff;-webkit-transform:scale(1.1);transform:scale(1.1)}html.is-hover .b8622b-banner .subscribe>a:focus{outline:0}html.is-hover .b8622b-banner .subscribe>a:focus:not(:active){color:#fff;-webkit-transform:scale(1.1);transform:scale(1.1)}.b8622b-banner .subscribe>a:active,html.is-hover .b8622b-banner .subscribe>a:hover:active{color:#fff;-webkit-transform:scale(.95);transform:scale(.95)}.b8622b-banner.mod-pwa{height:50vh}.b8622b-list{padding:20px 0 60px;position:relative}.b8622b-list:after,.b8622b-list:before{bottom:0;content:"";left:0;position:absolute;right:0;top:0}.b8622b-list:before{background:radial-gradient(ellipse at bottom,#f6f8f8 25%,#d7dee2 100%);z-index:-2}.b8622b-list:after{background:linear-gradient(135deg,#708090 21px,#d9ecff 22px,#d9ecff 24px,transparent 0,transparent 67px,#d9ecff 0,#d9ecff 69px,transparent 0),linear-gradient(225deg,#708090 21px,#d9ecff 22px,#d9ecff 24px,transparent 0,transparent 67px,#d9ecff 0,#d9ecff 69px,transparent 0) 0 64px;background-color:#708090;background-size:64px 128px;opacity:.05;z-index:-1}.b8622b-list>.header{padding:20px 0 24px;position:-webkit-sticky;position:sticky;top:-1px;transition:none .2s ease-out;transition-property:box-shadow;z-index:50}.b8622b-list>.header:after{background:hsla(0,0%,100%,.95);border-bottom:1px solid rgba(0,0,0,.15);bottom:0;content:"";left:0;opacity:0;position:absolute;right:0;top:-20px;transition:inherit;transition-property:opacity;z-index:-1}@supports ((-webkit-backdrop-filter:blur(20px) saturate(180%)) or (backdrop-filter:blur(20px) saturate(180%))){.b8622b-list>.header:after{background:hsla(0,0%,100%,.65)}}.b8622b-list>.header>.wrapper{-webkit-align-items:center;align-items:center;display:-webkit-flex;display:flex;-webkit-flex-flow:row wrap;flex-flow:row wrap;-webkit-justify-content:space-around;justify-content:space-around}.b8622b-list>.header.is-sticky{box-shadow:0 0 10px rgba(0,0,0,.1)}.b8622b-list>.header.is-sticky:after{-webkit-backdrop-filter:blur(20px) saturate(180%);backdrop-filter:blur(20px) saturate(180%);opacity:1}.b8622b-list>.header .title{-webkit-flex:1;flex:1;margin:0}.b8622b-list>.header .sources{-webkit-align-items:center;align-items:center;color:#78909b;cursor:default;display:-webkit-flex;display:flex;-webkit-flex-flow:row nowrap;flex-flow:row nowrap;font-size:14px;text-align:right;white-space:nowrap}.b8622b-list>.header .sources .btn-source{background:none;border:0;color:inherit;cursor:pointer;display:inline-block;margin:0 0 0 .75em;padding:0;transition:-webkit-transform .2s ease-out;transition:transform .2s ease-out;transition:transform .2s ease-out,-webkit-transform .2s ease-out}html.is-hover .b8622b-list>.header .sources .btn-source:hover{-webkit-transform:scale(1.2);transform:scale(1.2)}html.is-hover .b8622b-list>.header .sources .btn-source:focus{outline:0}html.is-hover .b8622b-list>.header .sources .btn-source:focus:not(:active){-webkit-transform:scale(1.2);transform:scale(1.2)}.b8622b-list>.header .sources .btn-source:active,html.is-hover .b8622b-list>.header .sources .btn-source:hover:active{-webkit-transform:scale(.95);transform:scale(.95)}.b8622b-list>.header .sources .btn-source .icon{fill:currentColor;color:inherit;height:24px;width:24px}.b8622b-list>.header .sources .btn-source.is-on[data-source=bilibili]{color:#07a3d7}.b8622b-list>.header .sources .btn-source.is-on[data-source=youtube]{color:red}.b8622b-list>.header .tags{-webkit-flex:1 0 100%;flex:1 0 100%;margin-top:.75em;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.b8622b-list>.header .tags .tag{cursor:pointer;margin:.75em .75em 0 0}.b8622b-list>.header .tags .tag.is-on{cursor:default}.b8622b-list>.header .tags .tag.is-on:after{border:6px solid transparent;border-bottom-color:inherit;content:"";left:50%;margin-left:-6px;margin-top:.5em;position:absolute;top:50%}.b8622b-list>.list-wrapper{border-top:15px solid transparent}.b8622b-footer{cursor:default;font-size:14px;line-height:1.5;padding:26px 0;text-align:center}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "includes/asset.2703dbafaffc8066597114554adab17f.svg");
  ...
  if (isDev || typeof injectCache[scriptsInBody] === 'undefined') {
    ...
    defaultEntrypoints.forEach(key => {
      if (Array.isArray(entrypoints[key])) {
        r += entrypoints[key].filter(file => /\.(js|jsx|mjs|ejs)$/.test(file)) // 将第一次请求时产生的热更新过滤掉
        .filter(file => !/\.hot-update\.js$/.test(file)).map(file => {
...
const validateReduxConfig = (kootConfigRedux = {}) => {
  ...
  if (typeof kootConfigRedux.store === 'undefined') {
    ...
    reduxConfig.factoryStore = () => (0,redux__WEBPACK_IMPORTED_MODULE_0__.createStore)((0,redux__WEBPACK_IMPORTED_MODULE_0__.combineReducers)(theReducers), // theInitialState,
    _redux__WEBPACK_IMPORTED_MODULE_1__.initialState, (0,redux__WEBPACK_IMPORTED_MODULE_0__.applyMiddleware)(..._redux__WEBPACK_IMPORTED_MODULE_1__.middlewares));
...
module.exports = {
  dll: '/__koot_dev_dll',
  serviceWorker: `/__KOOT_DEV_SERVICE_WORKER.${ true ? encodeURIComponent("飞行员大波胡") : 0}.js`
};
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var koot__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! koot */ "./node_modules/koot/index.js");
/* harmony import */ var _reducers_videos__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./reducers/videos */ "./src/store/reducers/videos.js");
/* harmony import */ var _reducers_app__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./reducers/app */ "./src/store/reducers/app.js");
...
const appReducer = {
  app: _reducers_app__WEBPACK_IMPORTED_MODULE_1__.default,
  videos: _reducers_videos__WEBPACK_IMPORTED_MODULE_0__.default
};
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => (0,koot__WEBPACK_IMPORTED_MODULE_2__.createStore)(appReducer, appMiddlewares));
...
/* harmony import */ var _constants_app_mode__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @constants/app-mode */ "./src/constants/app-mode.ts");


const initialState = {
  mode: _constants_app_mode__WEBPACK_IMPORTED_MODULE_1__.NORMAL
};
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(state = initialState, {
  ...
  switch (type) {
    case _constants_action_types__WEBPACK_IMPORTED_MODULE_0__.SET_APP_MODE:
      {
        return { ...state,
          mode: payload
        };
...
/* harmony import */ var _api_videos__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @api/videos */ "./src/api/videos.ts");
...
/* harmony import */ var _components_tag__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @components/tag */ "./src/components/tag/index.tsx");
/* harmony import */ var _constants_video_sources__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @constants/video-sources */ "./src/constants/video-sources.ts");
/* harmony import */ var _index_module_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./index.module.less */ "./src/components/video-list/index.module.less");
...
let VideoList = (_dec = (0,koot__WEBPACK_IMPORTED_MODULE_7__.default)({
  connect: state => {
    var _state$videos;
  ...
  data: (state, renderProps, dispatch) => dispatch((0,_api_videos__WEBPACK_IMPORTED_MODULE_1__.getVideoList)()),
  styles: _index_module_less__WEBPACK_IMPORTED_MODULE_5__.default
}), _dec(_class = class VideoList extends react__WEBPACK_IMPORTED_MODULE_0__.PureComponent {
  constructor(...args) {
    super(...args);
  ...
  render() {
    ...
    return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("div", {
      ...
      children: this.props.list.filter(({
        release
      }) => now > release).filter(({
        tag
      }) => !this.props.tag || tag.includes(this.props.tag)).map(item => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(Item, {
        video: item,
...
const Item = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({
  video: {
    name,
    thumbnail,
    link,
  ...
  const P = {
    className: `${_index_module_less__WEBPACK_IMPORTED_MODULE_5__.wrapper}-item`
  };
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)(C, { ...P,
    ...
    }), !source && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
      className: "links",
      children: _constants_video_sources__WEBPACK_IMPORTED_MODULE_4__.default.map(source => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("a", {
        href: link[source],
        target: "_blank",
        rel: "noreferrer",
        className: source,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_icon__WEBPACK_IMPORTED_MODULE_2__.default, {
          className: "icon",
          icon: source
        }), _constants_video_sources__WEBPACK_IMPORTED_MODULE_4__.names[source]]
      }, source))
    }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("span", {
      className: "infos",
      children: [Array.isArray(tag) && tag.length && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)("span", {
        className: "tags",
        children: tag.map(t => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsx)(_components_tag__WEBPACK_IMPORTED_MODULE_3__.default, {
          className: "tag",
          tag: t
        }, t))
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_6__.jsxs)("span", {
        className: "date",
        children: [time.getFullYear(), " / ", time.getMonth() + 1, " /", ' ', time.getDate()]
...
const listStickyContext = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.createContext)({
  value: false,
...
const Banner = (0,koot__WEBPACK_IMPORTED_MODULE_16__.default)({
  ...
  const {
    value: listSticky
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(listStickyContext);
  const setStylesDo = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(evt => {
    // reset the tick so we can
    // capture the next onScroll
    Banner.ticking = false;
    if (listSticky) return;
    const wrapperHeight = WrapperRef.current.offsetHeight;
    WrapperRef.current.style.setProperty('--scale', Math.min(1, Math.max(0, (wrapperHeight - window.scrollY) / wrapperHeight // * 1.2
    )));
    VideoRef.current.style.setProperty('--offsetY', window.scrollY / 2); // console.log(
    //     window.scrollY,
    //     pos,
    //     WrapperRef.current,
    //     VideoRef.current
  ...
  const setStyles = (0,react__WEBPACK_IMPORTED_MODULE_0__.useCallback)(evt => {
    if (!Banner.ticking) {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    ...
    window.addEventListener('scroll', setStyles); // VideoRef.current.play();
...
const List = (0,koot__WEBPACK_IMPORTED_MODULE_16__.default)({
  ...
  function scrollToList() {
    ...
    window.scrollTo(0, 4 + top + window.pageYOffset || document.documentElement.scrollTop);
  }

  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!HeaderRef || !HeaderRef.current) return;
    if (List.observer) return;
    List.observer = new IntersectionObserver(([e]) => {
      ...
      // );
      setSticky(e.boundingClientRect.top <= 0 && e.intersectionRatio < 1 && e.intersectionRatio > 0);
    }, {
      threshold: [1, 0]
    });
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    if (!category) return;
    scrollToList(); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, []);
  ...
  function selectTag(evt) {
    setTimeout(() => {
      scrollToList();
    }, 10); // const targetTag = evt.currentTarget.getAttribute('data-tag');
      ...
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsxs)(_components_center__WEBPACK_IMPORTED_MODULE_7__.default, {
        ...
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)("h2", {
          ...
          children: List.tags.map(({
            ...
            to: `/${value}`,
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_15__.jsx)(_components_tag__WEBPACK_IMPORTED_MODULE_8__.default, {
              onClick: selectTag,
...
const videos = [{
  ...
  thumbnail: 'thumbnails/4f89886bafc157529108124bf81ade03.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/101db63cba5b42922f0e902bf4ed5355.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/107c7043f981947e9633f9c21eef482e.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/008b538f2985d8be56bf11e4fdf55ff0.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/67c0516cc39eb22eba0ae3c1f9e73390.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/db269d1c0763281ac2ca99b9dd53b63c.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/c4b19135c81e528b1cc439bf4ba07bdb.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/62ebcfad5e569047a87f89ba8ffb000f.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/b599594de75e58bfceb64d10d1dc373d.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/db820631ddc9a367433554e9d35c02b4.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/43e9d3df8aa8fd546275ec6b455e7b98.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/8a940b9fcde6692b3b704b98e11df0fa.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/f63ac43d7acbe7a68f54bf94a4d7de5f.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/46f85ef0a475cd2e3696fd9ce617f479.jpg',
  link: {
  ...
  thumbnail: 'thumbnails/fbefbdc0619bafb7029275eca4f18b90.jpg',
  link: {
...
const setAppMode = newMode => dispatch => dispatch({
  type: _constants_action_types__WEBPACK_IMPORTED_MODULE_0__.SET_APP_MODE,
  payload: newMode
});
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getVideoList": () => (/* binding */ getVideoList)
/* harmony export */ });
/* harmony import */ var koot__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! koot */ "./node_modules/koot/libs/ssr/context.js");
/* harmony import */ var koot__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(koot__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _constants_action_types__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @constants/action-types */ "./src/constants/action-types.ts");
/* eslint-disable @typescript-eslint/no-var-requires */
  ...
  if (true) {
    ...
    return dispatch({
      ...
      payload: list.map(({
        ...
        return {
          name: (_name$getLocaleId = name[(0,koot__WEBPACK_IMPORTED_MODULE_1__.getLocaleId)()]) !== null && _name$getLocaleId !== void 0 ? _name$getLocaleId : name.zh,
          des: (_des$getLocaleId = des[(0,koot__WEBPACK_IMPORTED_MODULE_1__.getLocaleId)()]) !== null && _des$getLocaleId !== void 0 ? _des$getLocaleId : name.zh,
          ...o
        };
      })
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SET_APP_MODE": () => (/* binding */ SET_APP_MODE),
/* harmony export */   "UPDATE_VIDEO_LIST": () => (/* binding */ UPDATE_VIDEO_LIST)
/* harmony export */ });
...
/* harmony export */   "PWA": () => (/* binding */ PWA)
/* harmony export */ });
const NORMAL = 'normal';
const PWA = 'pwa';
...
/* harmony export */   "names": () => (/* binding */ names)
/* harmony export */ });
const tags = ['airport', 'route', 'news', 'landing', 'tour', 'device', 'mod', 'flight', 'training', 'clip'];
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var koot__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! koot */ "./node_modules/koot/React/component-extender.jsx");
...
const Center = (0,koot__WEBPACK_IMPORTED_MODULE_4__.default)({
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var koot__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! koot */ "./node_modules/koot/React/component-extender.jsx");
/* harmony import */ var _constants_video_tags__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @constants/video-tags */ "./src/constants/video-tags.ts");
/* harmony import */ var _index_module_less__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index.module.less */ "./src/components/tag/index.module.less");
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! react/jsx-runtime */ "./node_modules/react/jsx-runtime.js");
...
// Functional Component =======================================================
const Tag = (0,koot__WEBPACK_IMPORTED_MODULE_4__.default)({
  styles: _index_module_less__WEBPACK_IMPORTED_MODULE_2__.default
})( /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_0__.memo)(({
  className,
  tag,
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)("span", {
    ...
    "data-tag": tag,
    ...props,
    children: label !== null && label !== void 0 ? label : _constants_video_tags__WEBPACK_IMPORTED_MODULE_1__.names[tag]
  });
}));
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "includes/asset.3c37282f79b4bd73d8d49c0b030381d4.jpg");
...
/* harmony import */ var _KOOT_PROJECT_CONFIG_FULL_PATHNAME___WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! __KOOT_PROJECT_CONFIG_FULL_PATHNAME__ */ "./logs/tmp/config/full.8bf1f53c4cb1990446b4015828bd296e.js");
