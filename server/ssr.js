...
/***/ "./src/assets/banner/30fps/best.webm":
/*!*******************************************!*\
  !*** ./src/assets/banner/30fps/best.webm ***!
  \*******************************************/
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "includes/asset.58217d89cee74c3159929baeb49c903c.webm");

/***/ }),

/***/ "./src/assets/banner/30fps/medium.mp4":
/*!********************************************!*\
  !*** ./src/assets/banner/30fps/medium.mp4 ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "includes/asset.e4006c95357679c62bdde335449ee83c.mp4");
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const wrapper = 'c81c13';const css = '.c81c13{position:relative;width:100%;max-width:1280px;margin-left:auto;margin-right:auto;border-left:40px solid transparent;border-right:40px solid transparent}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var D_Projects_diablohu_sp_diablohu_com_src_assets_banner_cover_jpg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./src/assets/banner/cover.jpg */ "./src/assets/banner/cover.jpg");
...
const wrapper = 'd47d0c';const css = '.d47d0c,.d47d0c-banner{position:relative}.d47d0c-banner{background:no-repeat 50% 50%;background-size:cover;background-image:url("' + D_Projects_diablohu_sp_diablohu_com_src_assets_banner_cover_jpg__WEBPACK_IMPORTED_MODULE_0__.default + '");width:100%;height:75vh;min-height:340px;max-height:800px;overflow:hidden}.d47d0c-banner:after,.d47d0c-banner:before,.d47d0c-banner>.video,.d47d0c-banner>.wrapper{content:"";position:absolute;top:0;bottom:0;left:0;right:0;-webkit-flex:none;flex:none}.d47d0c-banner:after{z-index:10;background:rgba(0,0,0,.15)}.d47d0c-banner:before{z-index:100;background-image:radial-gradient(rgba(0,0,0,.1) 66.6667%,transparent 0);background-size:4px 4px}.d47d0c-banner>.wrapper{--scale:1;z-index:200;display:-webkit-flex;display:flex;-webkit-flex-flow:column nowrap;flex-flow:column nowrap;-webkit-justify-content:space-around;justify-content:space-around;-webkit-align-items:center;align-items:center;padding:0 30px;opacity:var(--scale);-webkit-transform:scale(var(--scale));transform:scale(var(--scale));-webkit-transform-origin:50% 100%;transform-origin:50% 100%}.d47d0c-banner>.wrapper:after,.d47d0c-banner>.wrapper:before{content:"";-webkit-flex:1;flex:1}.d47d0c-banner>.video{--offsetY:0;z-index:1;width:100%;height:100%;object-fit:cover;-webkit-transform:translateY(calc(var(--offsetY)*1px));transform:translateY(calc(var(--offsetY)*1px))}.d47d0c-banner .logo{-webkit-flex:1;flex:1;color:transparent;background:url("' + D_Projects_diablohu_sp_diablohu_com_src_assets_sim_pilot_plate_svg__WEBPACK_IMPORTED_MODULE_1__.default + '") no-repeat 50% 50%;background-size:contain;margin:0;padding:0;min-height:200px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.d47d0c-banner .subscribe{-webkit-flex:none;flex:none;padding-top:5vh}.d47d0c-banner .subscribe>a{display:inline-block;line-height:40px;border-radius:10px;padding-left:60px;padding-right:20px;color:#fff;position:relative;text-decoration:none;margin:0 10px;transition:-webkit-transform .2s ease-out;transition:transform .2s ease-out;transition:transform .2s ease-out,-webkit-transform .2s ease-out}.d47d0c-banner .subscribe>a>.icon{content:"";position:absolute;display:block;top:7px;left:10px;bottom:7px;height:26px;width:40px;background:no-repeat 50% 50%;background-size:contain;fill:#fff}.d47d0c-banner .subscribe>a.youtube{background:red}.d47d0c-banner .subscribe>a.bilibili{background:#07a3d7}html.is-hover .d47d0c-banner .subscribe>a:hover{color:#fff;-webkit-transform:scale(1.1);transform:scale(1.1)}html.is-hover .d47d0c-banner .subscribe>a:focus{outline:0}html.is-hover .d47d0c-banner .subscribe>a:focus:not(:active){color:#fff;-webkit-transform:scale(1.1);transform:scale(1.1)}.d47d0c-banner .subscribe>a:active,html.is-hover .d47d0c-banner .subscribe>a:hover:active{color:#fff;-webkit-transform:scale(.95);transform:scale(.95)}.d47d0c-banner.mod-pwa{height:50vh}.d47d0c-list{position:relative;padding:20px 0 60px}.d47d0c-list:after,.d47d0c-list:before{content:"";position:absolute;top:0;bottom:0;left:0;right:0}.d47d0c-list:before{z-index:-2;background:radial-gradient(ellipse at bottom,#f6f8f8 25%,#d7dee2 100%)}.d47d0c-list:after{z-index:-1;opacity:.05;background:linear-gradient(135deg,#708090 21px,#d9ecff 22px,#d9ecff 24px,transparent 0,transparent 67px,#d9ecff 0,#d9ecff 69px,transparent 0),linear-gradient(225deg,#708090 21px,#d9ecff 22px,#d9ecff 24px,transparent 0,transparent 67px,#d9ecff 0,#d9ecff 69px,transparent 0) 0 64px;background-color:#708090;background-size:64px 128px}.d47d0c-list>.header{position:-webkit-sticky;position:sticky;top:-1px;z-index:50;padding:20px 0 24px;transition:none .2s ease-out;transition-property:box-shadow}.d47d0c-list>.header:after{content:"";z-index:-1;position:absolute;top:-20px;bottom:0;left:0;right:0;opacity:0;transition:inherit;transition-property:opacity;background:hsla(0,0%,100%,.95);border-bottom:1px solid rgba(0,0,0,.15)}@supports ((-webkit-backdrop-filter:blur(20px) saturate(180%)) or (backdrop-filter:blur(20px) saturate(180%))){.d47d0c-list>.header:after{background:hsla(0,0%,100%,.65)}}.d47d0c-list>.header>.wrapper{display:-webkit-flex;display:flex;-webkit-flex-flow:row wrap;flex-flow:row wrap;-webkit-justify-content:space-around;justify-content:space-around;-webkit-align-items:center;align-items:center}.d47d0c-list>.header.is-sticky{box-shadow:0 0 10px rgba(0,0,0,.1)}.d47d0c-list>.header.is-sticky:after{opacity:1;-webkit-backdrop-filter:blur(20px) saturate(180%);backdrop-filter:blur(20px) saturate(180%)}.d47d0c-list>.header .title{-webkit-flex:1;flex:1;margin:0}.d47d0c-list>.header .sources{white-space:nowrap;text-align:right;display:-webkit-flex;display:flex;-webkit-flex-flow:row nowrap;flex-flow:row nowrap;-webkit-align-items:center;align-items:center;font-size:14px;color:#78909b;cursor:default}.d47d0c-list>.header .sources .btn-source{display:inline-block;border:0;padding:0;margin:0 0 0 .75em;background:none;color:inherit;cursor:pointer;transition:-webkit-transform .2s ease-out;transition:transform .2s ease-out;transition:transform .2s ease-out,-webkit-transform .2s ease-out}html.is-hover .d47d0c-list>.header .sources .btn-source:hover{-webkit-transform:scale(1.2);transform:scale(1.2)}html.is-hover .d47d0c-list>.header .sources .btn-source:focus{outline:0}html.is-hover .d47d0c-list>.header .sources .btn-source:focus:not(:active){-webkit-transform:scale(1.2);transform:scale(1.2)}.d47d0c-list>.header .sources .btn-source:active,html.is-hover .d47d0c-list>.header .sources .btn-source:hover:active{-webkit-transform:scale(.95);transform:scale(.95)}.d47d0c-list>.header .sources .btn-source .icon{width:24px;height:24px;color:inherit;fill:currentColor}.d47d0c-list>.header .sources .btn-source.is-on[data-source=bilibili]{color:#07a3d7}.d47d0c-list>.header .sources .btn-source.is-on[data-source=youtube]{color:red}.d47d0c-list>.header .tags{-webkit-flex:1 0 100%;flex:1 0 100%;margin-top:.75em;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none}.d47d0c-list>.header .tags .tag{margin:.75em .75em 0 0;cursor:pointer}.d47d0c-list>.header .tags .tag.is-on{cursor:default}.d47d0c-list>.header .tags .tag.is-on:after{content:"";position:absolute;border:6px solid transparent;left:50%;top:50%;margin-left:-6px;border-bottom-color:inherit;margin-top:.5em}.d47d0c-list>.list-wrapper{border-top:15px solid transparent}.d47d0c-footer{cursor:default;padding:26px 0;font-size:14px;line-height:1.5;text-align:center}';/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({wrapper,css});
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
    ...
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)("source", {
        type: "video/webm",
        src: __webpack_require__(/*! @assets/banner/30fps/best.webm */ "./src/assets/banner/30fps/best.webm").default
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_14__.jsx)("source", {
        type: "video/mp4",
        src: __webpack_require__(/*! @assets/banner/30fps/medium.mp4 */ "./src/assets/banner/30fps/medium.mp4").default
      })]
    })]
  });
}));
