...
const List = (0,koot__WEBPACK_IMPORTED_MODULE_16__.default)({
  ...
  function scrollToList() {
    ...
    window.scrollTo(0, top + window.pageYOffset || document.documentElement.scrollTop);
  }
